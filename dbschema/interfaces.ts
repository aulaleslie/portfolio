...
export namespace $default {
  export interface Competition extends std.$Object {
    "created_at": Date;
  ...
  export interface Match extends std.$Object {
    "created_at": Date;
  ...
  export type MatchFormat = "Single" | "HomeAway";
  export interface MatchSet extends std.$Object {
    "score_a": number;
    "score_b": number;
    "set_number": number;
    "match": Match;
  ...
  export type ScoringMode = "SumScore" | "SetWins";
}
export type Competition = $default.Competition;
export type Match = $default.Match;
export type MatchFormat = $default.MatchFormat;
export type MatchSet = $default.MatchSet;
export type Player = $default.Player;
export type ScoringMode = $default.ScoringMode;
...
export interface types {
  ...
  "default": {
    ...
    "Match": $default.Match;
    "MatchFormat": $default.MatchFormat;
    "MatchSet": $default.MatchSet;
    "Player": $default.Player;
    "ScoringMode": $default.ScoringMode;
  };
  "schema": {
